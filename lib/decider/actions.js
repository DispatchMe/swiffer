...
ScheduleAction.prototype.getDecision = function () {
  return {
    ...
    scheduleActivityTaskDecisionAttributes: {
      ...
      input: this._input,
      scheduleToStartTimeout: String(this._activityConfig.scheduleToStartTimeout) || '60',
      scheduleToCloseTimeout: String(this._activityConfig.scheduleToCloseTimeout) || '360',
      startToCloseTimeout: String(this._activityConfig.startToCloseTimeout) || '300',
      heartbeatTimeout: String(this._activityConfig.heartbeatTimeout) || '60'
